...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (!avatar) {
    throw new ApiError(400, "Avatar file is not being uploaded");
  }
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //find the user
  //password check
  //if password is correct then generate access and refresh token and give both to user and server
  //send cookie
  ...
  //from this frontend wont be able to modify any cookies only server can modify
  const options = {
    httpOnly: true,
    secure: true,
  };
